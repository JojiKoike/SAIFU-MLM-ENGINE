...
class SessionCache(
  ...
  def behavior(children: Map[String, ActorRef[RefreshSession.type]]): Behavior[Command] =
  ...
  private def refreshSessionExpiration(
      key: String,
      children: Map[String, ActorRef[RefreshSession.type]]
  ): Behavior[Command] = {
